...
const foodPosts = <FoodPost>[
  ...
  FoodPost(
    ...
    restaurantName: 'Burger Lab',
    author: 'Santi P.',
    authorRole: 'Compra verificada',
    imageAsset: 'images/burguer_house/banner_burguer1.jpg',
    caption:
        'Pedí Clásica Burger en Burger Lab y me gustó por delicioso, llegó a tiempo y venía con actitud de campeón.',
    likesLabel: '864',
    commentsLabel: '0',
    tags: ['delicioso', 'a tiempo', 'actitud de campeon'],
    featuredDishName: 'Clásica Burger',
  ...
  FoodPost(
    ...
    imageAsset: 'images/el_tambeno/tambeno_plato4.jpg',
    caption:
        'Pedí Seviche de camarones en Restaurante El Tambello y destacó por fresco, recien salido del hielo fino y con sabor serio.',
    likesLabel: '1.1k',
    commentsLabel: '0',
    tags: ['fresco', 'recien salido', 'sabor serio'],
    featuredDishName: 'Seviche de camarones',
    isVerifiedOrder: true,
  ),
  FoodPost(
    id: 'post-user-3',
    ...
    imageAsset: 'images/vegano/vegan_banner2.jpg',
    caption:
        'Pedí Bowl vegano en Veggie Heaven y salió poderoso: delicioso, bien presentado y más puntual que reloj de juzgado.',
    likesLabel: '742',
    commentsLabel: '0',
    tags: ['delicioso', 'bien presentado', 'más puntual que reloj'],
    featuredDishName: 'Bowl vegano',
    isVerifiedOrder: true,
  ),
  FoodPost(
    id: 'post-user-4',
    ...
    imageAsset: 'images/resto_papas/banner_papas.jpg',
    caption:
        'Pedí Papas loaded spicy en Papas Town y venían crujientes, a tiempo y recien salidas del pecado bonito.',
    likesLabel: '918',
    commentsLabel: '0',
    tags: ['crujientes', 'a tiempo', 'recien salidas del pecado'],
    featuredDishName: 'Papas loaded spicy',
    isVerifiedOrder: true,
  ),
];
...
const menuItemsByRestaurant = <int, List<MenuItemModel>>{
  ...
  2: [
    ...
    MenuItemModel(
      ...
      price: 12.90,
      description: 'Doble carne, cheddar fundido y cebolla crispy para un pedido más contundente.',
      coverImage: 'images/burguer_house/banner_burguer1.jpg',
      galleryImages: [
        'images/burguer_house/banner_burguer1.jpg',
        'images/burguer_house/banner_burguer.jpg',
        'images/burguer_house/banner_burguer2.jpg',
      ],
      ingredients: ['Pan brioche', 'Doble carne', 'Cheddar', 'Cebolla crispy'],
      calories: '910 kcal',
      prepTime: '14 min',
      customizations: ['Pepinillos +1', 'Salsa burger extra +1', 'Papas combo +3'],
    ),
    MenuItemModel(
      restaurantId: 2,
      name: 'Chicken Crunch Burger',
      price: 11.80,
      description: 'Pollo apanado, ensalada fresca y salsa de ajo para una salida rápida.',
      coverImage: 'images/burguer_house/banner_burguer.jpg',
      galleryImages: [
        'images/burguer_house/banner_burguer.jpg',
        'images/burguer_house/banner_burguer2.jpg',
        'images/burguer_house/banner_burguer1.jpg',
      ],
      ingredients: ['Pan artesanal', 'Pollo crunch', 'Lechuga', 'Salsa de ajo'],
      calories: '760 kcal',
      prepTime: '13 min',
      customizations: ['Queso americano +1.5', 'Jalapeños +1', 'Tocineta +2'],
    ),
  ],
  3: [
    MenuItemModel(
    ...
    MenuItemModel(
      ...
      name: 'Seco nariñense',
      price: 13.90,
      description: 'Carne jugosa, arroz y papa criolla con sabor casero y fondo intenso.',
      coverImage: 'images/mi_restaurante/restaurante_banner3.jpg',
      galleryImages: [
        'images/mi_restaurante/restaurante_banner3.jpg',
        'images/mi_restaurante/restaurante_banner2.jpg',
        'images/mi_restaurante/restaurante_banner1.jpg',
      ],
      ingredients: ['Res', 'Arroz', 'Papa criolla', 'Aliños de la casa'],
      calories: '880 kcal',
      prepTime: '18 min',
      customizations: ['Ají aparte', 'Arroz extra +1.5', 'Aguacate +2'],
    ),
    MenuItemModel(
      restaurantId: 3,
      name: 'Lomo en salsa criolla',
      price: 15.40,
      description: 'Lomo salteado con vegetales y salsa criolla para almuerzos fuertes.',
      coverImage: 'images/mi_restaurante/restaurante_banner2.jpg',
      galleryImages: [
        'images/mi_restaurante/restaurante_banner2.jpg',
        'images/mi_restaurante/restaurante_banner1.jpg',
        'images/mi_restaurante/restaurante_banner3.jpg',
      ],
      ingredients: ['Lomo', 'Pimentón', 'Cebolla', 'Salsa criolla'],
      calories: '790 kcal',
      prepTime: '17 min',
      customizations: ['Papas rústicas +2', 'Arroz de coco +2', 'Doble proteína +4'],
    ),
  ],
  4: [
    MenuItemModel(
    ...
    MenuItemModel(
      restaurantId: 4,
      name: 'Tostadas verdes',
      price: 10.50,
      description: 'Pan artesanal con aguacate, hummus y vegetales frescos.',
      coverImage: 'images/vegano/vegan_banner2.jpg',
      galleryImages: [
        'images/vegano/vegan_banner2.jpg',
        'images/vegano/vegan_banner1.jpg',
      ...
      ingredients: ['Pan integral', 'Aguacate', 'Hummus', 'Brotes'],
      calories: '430 kcal',
      prepTime: '8 min',
      customizations: ['Tofu grill +2', 'Semillas +1', 'Tomate seco +1.5'],
    ),
    MenuItemModel(
      restaurantId: 4,
      name: 'Wrap de tofu grill',
      price: 12.60,
      description: 'Wrap tibio con tofu marinado, vegetales y crema ligera de ajo.',
      coverImage: 'images/vegano/vegan_banner1.jpg',
      galleryImages: [
        'images/vegano/vegan_banner1.jpg',
        'images/vegano/vegan_banner2.jpg',
      ...
      ingredients: ['Tortilla integral', 'Tofu', 'Lechuga', 'Salsa ligera'],
      calories: '520 kcal',
      prepTime: '11 min',
      customizations: ['Más tofu +2.5', 'Guacamole +2', 'Picante suave'],
    ),
  ],
  5: [
    MenuItemModel(
    ...
    MenuItemModel(
      restaurantId: 5,
      name: 'Lomo sellado del chef',
      price: 18.40,
      description: 'Corte sellado con mantequilla especiada y vegetales al horno.',
      coverImage: 'images/mi_restaurante/restaurante_banner2.jpg',
      galleryImages: [
        'images/mi_restaurante/restaurante_banner2.jpg',
        'images/mi_restaurante/restaurante_banner1.jpg',
      ...
      ingredients: ['Lomo', 'Mantequilla', 'Vegetales', 'Reducción de la casa'],
      calories: '830 kcal',
      prepTime: '19 min',
      customizations: ['Puré cremoso +2', 'Champiñones +2', 'Término medio'],
    ),
    MenuItemModel(
      restaurantId: 5,
      name: 'Pasta cremosa de autor',
      price: 16.80,
      description: 'Pasta corta con salsa cremosa, queso curado y acabado aromático.',
      coverImage: 'images/mi_restaurante/restaurante_banner3.jpg',
      galleryImages: [
        'images/mi_restaurante/restaurante_banner3.jpg',
        'images/mi_restaurante/restaurante_banner2.jpg',
      ...
      ingredients: ['Pasta', 'Crema ligera', 'Queso curado', 'Hierbas'],
      calories: '760 kcal',
      prepTime: '16 min',
      customizations: ['Proteína adicional +3', 'Trufa +2.5', 'Pan artesanal'],
    ),
  ],
  6: [
    MenuItemModel(
    ...
    MenuItemModel(
      restaurantId: 6,
      name: 'Papas BBQ pulled',
      price: 14.90,
      description: 'Papas con carne desmechada, salsa BBQ y cebolla crocante.',
      coverImage: 'images/resto_papas/banner_papas1.jpg',
      galleryImages: [
        'images/resto_papas/banner_papas1.jpg',
        'images/resto_papas/banner_papas.jpg',
      ],
      ingredients: ['Papas', 'Carne pulled', 'BBQ', 'Cebolla crispy'],
      calories: '910 kcal',
      prepTime: '16 min',
      customizations: ['Cheddar extra +2', 'Jalapeños +1', 'Salsa burger +1'],
    ),
    MenuItemModel(
      restaurantId: 6,
      name: 'Papas costeñas',
      price: 12.80,
      description: 'Versión con maíz, queso suave y salsa de ajo para pedir en combo.',
      coverImage: 'images/resto_papas/banner_papas.jpg',
      galleryImages: [
        'images/resto_papas/banner_papas.jpg',
        'images/resto_papas/banner_papas1.jpg',
      ],
      ingredients: ['Papas', 'Maíz', 'Queso suave', 'Salsa de ajo'],
      calories: '780 kcal',
      prepTime: '13 min',
      customizations: ['Pollo +3', 'Tocineta +2', 'Picante medio'],
    ),
  ],
  7: [
    MenuItemModel(
    ...
    MenuItemModel(
      ...
      name: 'Cazuela brava',
      price: 19.80,
      description: 'Base cremosa de mariscos con pescado, camarón y toque de coco.',
      coverImage: 'images/el_tambeno/tambeno_plato4.jpg',
      galleryImages: [
        'images/el_tambeno/tambeno_plato4.jpg',
        'images/el_tambeno/tambeno_plato3.jpg',
      ...
      ingredients: ['Mariscos', 'Leche de coco', 'Pescado', 'Aliños'],
      calories: '810 kcal',
      prepTime: '22 min',
      customizations: ['Patacón +2', 'Más mariscos +4', 'Ají aparte'],
    ),
    MenuItemModel(
      restaurantId: 7,
      name: 'Filete al ajillo',
      price: 17.60,
      description: 'Filete de pescado con ajillo suave y guarnición fresca.',
      coverImage: 'images/el_tambeno/tambeno_banner2.jpg',
      galleryImages: [
        'images/el_tambeno/tambeno_banner2.jpg',
        'images/el_tambeno/tambeno_plato3.jpg',
        'images/el_tambeno/tambeno_plato4.jpg',
      ],
      ingredients: ['Pescado', 'Ajo', 'Mantequilla', 'Limón'],
      calories: '690 kcal',
      prepTime: '18 min',
      customizations: ['Arroz de coco +2', 'Ensalada +1.5', 'Salsa criolla'],
    ),
  ],
  8: [
    MenuItemModel(
    ...
    MenuItemModel(
      restaurantId: 8,
      name: 'Panini de autor',
      price: 15.60,
      description: 'Panini caliente con queso derretido, vegetales y salsa ahumada.',
      coverImage: 'images/mi_restaurante/restaurante_plato2.jpg',
      galleryImages: [
        'images/mi_restaurante/restaurante_plato2.jpg',
        'images/mi_restaurante/restaurante_plato1.jpg',
        'images/mi_restaurante/restaurante_plato3.jpg',
      ],
      ingredients: ['Panini', 'Queso', 'Vegetales grill', 'Salsa ahumada'],
      calories: '720 kcal',
      prepTime: '14 min',
      customizations: ['Tocineta +2', 'Papas +3', 'Doble queso +1.5'],
    ),
    MenuItemModel(
      restaurantId: 8,
      name: 'Bowl fuego',
      price: 13.80,
      description: 'Bowl templado con proteína grill, vegetales y aderezo de la casa.',
      coverImage: 'images/mi_restaurante/restaurante_plato3.jpg',
      galleryImages: [
        'images/mi_restaurante/restaurante_plato3.jpg',
        'images/mi_restaurante/restaurante_plato1.jpg',
        'images/mi_restaurante/restaurante_plato2.jpg',
      ],
      ingredients: ['Arroz', 'Proteína grill', 'Vegetales', 'Aderezo'],
      calories: '640 kcal',
      prepTime: '12 min',
      customizations: ['Más proteína +3', 'Aguacate +2', 'Salsa picante +1'],
    ),
  ],
};
